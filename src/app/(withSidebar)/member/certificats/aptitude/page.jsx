...
export default function CertificatDAptitudePage() {
  ...
  async function handleGeneratePDF(values) {
    ...
    try {
      const response = await fetch("/api/certificats/certificate-aptitude", {
        method: "POST",
      ...
      a.href = url;
      a.download = "certificates-aptitude.pdf";
      a.click();
  ...
  return (
    <div className="container mx-auto py-6 px-4">
      <h1 className="text-2xl font-bold mb-6">استخراج شهادة الكفاءة</h1>
      <h1 className="text-xl font-semibold mb-6">
        Certificate d&apos;aptitude
      </h1>
