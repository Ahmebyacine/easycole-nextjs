...
export default function AttestationDeFormationPage() {
  ...
  async function handleGeneratePDF(values) {
    ...
    try {
      const response = await fetch("/api/certificats/attestation-formation", {
        method: "POST",
      ...
      a.href = url;
      a.download = "attestations-formation.pdf";
      a.click();
  ...
  return (
    <div className="container mx-auto py-6 px-4">
      <h1 className="text-2xl font-bold mb-6">استخراج شهادة التدريب</h1>
